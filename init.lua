...
minetest.register_node('deco_lamp:lamp_off_' ..material, {
	...
	groups = {cracky=2, oddly_breakably_by_hand=2, not_in_creative_inventory=1},
	paramtype = 'light',
	paramtype2 = 'facedir',
	selection_box = {
		type = 'fixed',
	...
	on_rightclick = function (pos, node, puncher)
		node.name = "deco_lamp:deco_lamp" ..material
...
minetest.register_node('deco_lamp:deco_lamp_' ..material, {
	...
	collision_box = {
		...
		on_rightclick = function (pos, node, puncher)
		node.name = "deco_lamp:_lamp_off" ..material
		minetest.set_node(pos, node)
	end,
})
end